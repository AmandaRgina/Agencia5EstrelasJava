	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Agencia 5Estrelas</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="CreateAndFind">Clientes</a>
						</li>
						<li class="nav-item"><a class="nav-link"
							href="CreateAndFindDestino">Destinos</a></li>
					</ul>
				...
				<div class="cold-md-7">
					...
					<form action="DestinoUpdate" method="POST">
						...
						<div class="form-floating mb-3">
							<input value="${destino.lugar}" name="lugar" maxlength="40"
								type="text" class="form-control" id="floatingInput1"> <label>Lugar</label>
						</div>
						<div class="form-floating mb-3">
							<input value="${destino.valor}" name="valor" maxlength="11"
								type="text" class="form-control"> <label>Valor</label>
						</div>
